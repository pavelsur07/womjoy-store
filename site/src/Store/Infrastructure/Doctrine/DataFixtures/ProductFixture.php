...
class ProductFixture extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $product = $this->productCreate(
            ...
            description: 'Легинсы с высокой посадкой выполнены из эластичного бифлекса. Широкий пояс обеспечивает комфортную посадку по фигуре, а дополнительный слой из эластичной сетки создает хорошую утяжку и поддержку. Для максимального комфорта легинсы сшиты плоским швом Flatlock. Флэтлок образует цепной стежок, что позволяет шву выдерживать большие нагрузки при растяжении, нитки при этом не рвутся. Шов надёжен, прочен и долговечен. Модель не сковывает движений и идеально подходит для занятий спортом и активного отдыха. Рекомендуем сочетать легинсы с топом или лонгсливами из данной капсулы. Изготовленно в России.',
            price: 1000,
            number: $i
        );
